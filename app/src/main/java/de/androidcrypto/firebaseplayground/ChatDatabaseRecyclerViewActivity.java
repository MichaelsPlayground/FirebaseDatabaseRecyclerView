...
public class ChatDatabaseRecyclerViewActivity extends AppCompatActivity implements FirebaseAuth.AuthStateListener {

    // see https://dpkpradhan649.medium.com/firebase-realtime-database-pagination-in-recyclerview-c3f9a4a7856f

    private static final String TAG = "ChatDatabaseRecyclView";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_database_recycler_view);
...
*/
    ...
    private void setDatabaseForRoomId(String ownUserUid, String receiveUserId) {
        ...
        Log.i(TAG, "room Id is " + roomId);
        headerTextView.setText("Chat in roomId " + roomId);
